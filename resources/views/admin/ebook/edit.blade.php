@extends(ADMIN)
@push('title', translate('Ebook Edit'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3 flex-wrap d-flex justify-content-between">
                            <div>
                                <h4 class="title fs-18px mb-2">{{ translate('Ebook Update') }}</h4>
                                <p class="sub-title fs-12px">{{ translate('Deshboard / Ebook Management / Update Ebook') }}
                                </p>
                            </div>
                            <div>
                                        ...
                                        <div class="w-100">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control ad-form-control" id="title"
                                                    value="{{ $ebook->title }}" name="title"
                                                    placeholder="{{ translate('Enter your Ebook title') }}">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control ad-form-control" id="publication"
                                                    name="publication" value="{{ $ebook->publication_name }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control ad-form-control" id="edition"
                                                    value="{{ $ebook->edition }}" name="edition"
                                                    placeholder="{{ translate('Enter Edition') }}">
                                            </div>

                                            <div class="mb-3">
                                                <label for="description"
                                                    class="form-label ad-form-label">{{ translate('Description') }}</label>
                                                <textarea placeholder="{{ translate('Hare ...') }}" id="summernote" name="description">{{ $ebook->description }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="ad-select2" name="category">
                                                    ...
                                                    @foreach (App\Models\EbookCategory::orderBy('title', 'desc')->get() as $category)
                                                        <option @if ($category->id == $ebook->category) selected @endif
                                                ...
                                                <div class="ad-radio-wrap d-flex flex-wrap">
                                                    <div class="form-check form-check-radio">
                                                        <input class="form-check-input form-check-input-radio"
                                                            ...
                                                            @if ($ebook->is_paid == 1) checked @endif>
                                                    ...
                                                    <div class="form-check form-check-radio">
                                                        <input class="form-check-input form-check-input-radio"
                                                            ...
                                                            @if ($ebook->is_paid == 0) checked @endif>
                                                        <label class="form-check-label form-check-label-radio"
                                                            for="price_type2">
                                                            {{ translate('Free') }}
                                                        </label>
                                            ...
                                            <div id="paid-section">
                                                ...
                                                <div class="form-check form-check-checkbox mb-3">
                                                    <input class="form-check-input form-check-input-checkbox"
                                                        ...
                                                        id="discounted" @if ($ebook->is_discount == 1) checked @endif>
