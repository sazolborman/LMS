@extends(ADMIN)
@push('title', translate('Ebook Management'))
@push('meta')
@endpush
@push('css')
@endpush
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-3 flex-wrap">
                                <h4 class="title fs-18px mb-2">{{ translate('Ebook Management') }}</h4>
                                <p class="sub-title fs-12px">
                                    {{ translate('Dashboard / Ebook Management ') }}</p>
                            </div>
                            <div>
                                <a href="{{ route('admin.ebook.create') }}"
                                    class="btn ad-btn-primary px-12px d-flex align-items-center cg-6px">
                                    <span><i class="fa-solid fa-plus"></i></span>
                                    <span>{{ translate('Add new Ebook') }}</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="table-title-option-area">
                                ...
                                <div class="table-filter-wrap four-filter-wrap">
                                    <input type="text" id="searchQuery" name="search"
                                        ...
                                        placeholder="{{ translate('Type user title and category') }}">
                                </div>
                            </div>
                            <div id="data-container">
                                @include('admin.ebook.data_container', ['ebooks' => $ebooks])
                            </div>
                        </div>
                    </div>
                </div>
