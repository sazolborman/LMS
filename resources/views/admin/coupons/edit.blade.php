...
<form action="{{ route('admin.coupon.update') }}" method="post">
    ...
    <div class="input-group-field mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <input type="text" class="form-control ad-form-control" name="code" id="code"
                placeholder="{{ translate('Coupon code') }}" value="{{ $coupon->code }}" required>
    ...
    <div class="input-group-field mb-3">
        ...
        <input type="date" class="form-control ad-form-control" name="expiry_date"
            value="{{ date('Y-m-d', $coupon->expiry_date) }}" id="expiry_date" required>
    </div>
