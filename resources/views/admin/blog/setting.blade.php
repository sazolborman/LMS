@extends(ADMIN)
@push('title', translate('Blog Setting'))
@push('meta')
@endpush
@push('css')
@endpush
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="ad-card">
                            <div class="row d-flex align-items-center">
                                <div class="col-md-6">
                                    <form class="ajaxForm" action="{{ route('admin.blog.setting.update') }}" method="post"
                                        ...
                                        <div class="ad-card-body mb-20px p-20px">
                                            ...
                                            <div class="mb-3">
                                                <label for="setting-language"
                                                    class="form-label ad-form-label">{{ translate('Instructors blog permission?') }}</label>
                                                <select class="ad-select2" data-minimum-results-for-search="Infinity"
                                                    name="instructors_permission">
                                                    <option @if (get_frontend_settings('instructors_blog_permission') == 'provide_access') selected @endif
                                                        value="provide_access">
                                                        {{ translate('Provide access') }}
                                                    </option>
                                                    <option @if (get_frontend_settings('instructors_blog_permission') == 'decline_access') selected @endif
                                                        value="decline_access">
                                                        {{ translate('Decline access') }}
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="setting-language"
                                                    class="form-label ad-form-label">{{ translate('Blog visibility on the home page?') }}</label>
                                                <select class="ad-select2" data-minimum-results-for-search="Infinity"
                                                    name="visibility_on_the_homepage">
                                                    <option @selected(get_frontend_settings('blog_visibility_on_the_home_page') == 'visible') value="visible">
                                                        {{ translate('Visible') }}</option>
                                                    <option @selected(get_frontend_settings('blog_visibility_on_the_home_page') == 'hidden') value="hidden">
                                ...
                                <div class="col-md-6">
                                    <div
                                        ...
                                        <div class="alert-content">
                                            ...
                                            <p class="fs-14px">
                                                {{ translate('Instructor blog permission and homepage visibility only can admin give.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
