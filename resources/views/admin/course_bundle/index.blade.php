@extends(ADMIN)
@push('title', translate('Course Bundle'))
@push('meta')
@endpush
@push('css')
@endpush
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-3 flex-wrap">
                                <h4 class="title fs-18px mb-2">{{ translate('Course Bundle Management') }}</h4>
                                <p class="sub-title fs-12px">
                                    {{ translate('Dashboard / Course Bundle / Course Bundle Management') }}</p>
                            </div>
                            <div>
                                <a href="{{ route('admin.bundle.create') }}"
                                    class="btn ad-btn-primary px-12px d-flex align-items-center cg-6px">
                                    <span><i class="fa-solid fa-plus"></i></span>
                                    <span>{{ translate('Add new Bundle') }}</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="table-title-option-area">
                                ...
                                <div class="table-filter-wrap four-filter-wrap">
                                    <input type="text" id="searchQuery" name="search"
                                        class="form-control mform-control custom-ad-search" placeholder="Type coupon code">
                                </div>
                            </div>
                            <div id="data-container">
                                @include('admin.course_bundle.data_container', ['bundles' => $bundles])
                            </div>
                        </div>
                    </div>
                </div>
