@extends(ADMIN)
@push('title', translate('Student Management'))
@push('meta')
@endpush
@push('css')
@endpush
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-3 flex-wrap">
                                <h4 class="title fs-18px mb-2">{{ translate('Student Management') }}</h4>
                                <p class="sub-title fs-12px">{{ translate('Dashboard / Users / Student Management') }}</p>
                            </div>
                            <div>
                        ...
                        <div class="dashboard-table-wrap">
                            ...
                            <div id="data-container">
                                @include('admin.users.student.data_container', ['students' => $students])
                            </div>
                        </div>
                    </div>
                </div>
