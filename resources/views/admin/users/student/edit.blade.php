@extends(ADMIN)
@push('title', translate('Student Edit'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3 flex-wrap d-flex justify-content-between">
                            <div>
                                <h4 class="title fs-18px mb-2">{{ translate('Student Create') }}</h4>
                                <p class="sub-title fs-12px">{{ translate('Deshboard / Users / Student Create') }}</p>
                            </div>
                            <div>
                            ...
                            <form action="{{ route('admin.student.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="ad-card-body mb-20px p-20px">
                                    <div class="admin-info">
                                        <h4 class="title fs-16px mb-3">{{ translate('Student Information') }}</h4>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea placeholder="{{ translate('Hare ...') }}" id="summernote" name="biography">{{ $student->about }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="w-100">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="facbook" name="facbook" value="{{ $student->facbook }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="instagram" name="instagram" value="{{ $student->instagram }}"
                                            ...
                                            <div class="w-100">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="linkedin" name="linkedin" value="{{ $student->linkedin }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="twitter" name="twitter" value="{{ $student->twitter }}"
