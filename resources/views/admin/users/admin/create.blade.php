@extends(ADMIN)
@push('title', translate('Admin Create'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3 flex-wrap d-flex justify-content-between">
                            <div>
                                <h4 class="title fs-18px mb-2">{{ translate('Admin Create') }}</h4>
                                <p class="sub-title fs-12px">{{ translate('Deshboard / Users / Admin Create') }}</p>
                            </div>
                            <div>
