@extends(ADMIN)
@push('title', translate('Instructor Edit'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3 flex-wrap d-flex justify-content-between">
                            <div>
                                <h4 class="title fs-18px mb-2">{{ translate('Update Instructor') }}</h4>
                                <p class="sub-title fs-12px">
                                    {{ translate('Deshboard / Users / Instructor manage / Update Instructor') }}</p>
                            </div>
                            <div>
                                ...
                                <div class="ad-card-body mb-20px p-20px">
                                    <div class="admin-info">
                                            ...
                                            <div class="w-100">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="name" name="name" value="{{ $instructor->name }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="address" name="address" value="{{ $instructor->address }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea placeholder="{{ translate('Hare ...') }}" id="summernote" name="biography">{{ $instructor->about }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="w-100">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="facbook" name="facbook" value="{{ $instructor->facbook }}"
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control ad-form-control"
                                                        id="twitter" name="twitter" value="{{ $instructor->twitter }}"
