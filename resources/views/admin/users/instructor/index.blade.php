@extends(ADMIN)
@push('title', translate('Instructor Management'))
@push('meta')
@endpush
@push('css')
@endpush
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-3 flex-wrap">
                                <h4 class="title fs-18px mb-2">{{ translate('Instructor Management') }}</h4>
                                <p class="sub-title fs-12px">{{ translate('Dashboard / Users / Instructor Management') }}</p>
                            </div>
                            <div>
                                <a href="{{ route('admin.instructor.create') }}"
                                    class="btn ad-btn-primary px-12px d-flex align-items-center cg-6px">
                                    <span><i class="fa-solid fa-plus"></i></span>
                                    <span>{{ translate('Add new Instructor') }}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="dashboard-table-wrap">
                            ...
                            <div id="data-container">
                                @include('admin.users.instructor.data_container', [
