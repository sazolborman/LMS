@php
    $faqs = json_decode($courses->faqs);
    $outcomes = json_decode($courses->outcomes, true);
    $requirements = json_decode($courses->requirements, true);
@endphp
...
<div class="ad-card-body mb-20px p-20px">
    <div class="w-100">
        {{-- FAQ area start --}}
        <div id = "faq_area">
            <label for="title" class="form-label ad-form-label">{{ translate('Course FAQ') }}</label>
        ...
        <div id = "requirement_area">
            <label for="title" class="form-label ad-form-label">{{ translate('Course Requirements') }}</label>
        ...
        <div id = "outcomes_area">
            <label for="title" class="form-label ad-form-label">{{ translate('Course Outcomes') }}</label>
