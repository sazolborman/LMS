...
class FileUploader extends Model
{
    ...
    {
        // EXample: $upload_file = this is the uploaded temp file => $request->video_feild_name
        // EXample: $upload_to = "public/storage/video" OR "public/storage/video/Sj8Ro5Gksde3T.mp4" OR "sdsdncts7sn.png" OR empty if amazon s3 is active
        // EXample: $width and $height => Image width and height
        // EXample: $optimized_width and $optimized_height ultra optimization, That is stored in optimized folder
        ...
        $s3_keys = settings_data('amazon_s3', 'object');
